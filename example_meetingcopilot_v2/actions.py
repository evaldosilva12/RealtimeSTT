...
class ActionService:
    ...
    def _build_messages(
        ...
        task = {
            ...
            "clarify": "Create a short clarification as me. Make it simple and easy to say.",
            "ask_question": "Create one thoughtful question I can ask next.",
            "push_back": "Create a polite pushback response as me. Keep it calm and practical.",
            "summarize_context": "Summarize what the other participants are saying and identify the best next response.",
            "next_step": "Create a concise next-step suggestion I can say in the meeting.",
            "improve_answer": "Improve the previous draft. Keep it natural, concise, and stronger for a live meeting.",
